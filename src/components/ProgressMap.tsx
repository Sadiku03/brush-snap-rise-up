...
const ProgressMap = () => {
  ...
  return <div className="bg-white rounded-xl shadow-md border border-lilac/20 overflow-hidden">
      <div className="bg-skyblue/20 border-b border-lilac/10 p-4 flex justify-between items-center">
        ...
        <Button variant="ghost" size="sm" onClick={() => setExpanded(!expanded)} className="text-indigo/70">
      ...
      <div className={`transition-all duration-300 ${expanded ? 'max-h-[500px]' : 'max-h-64'} overflow-hidden`}>
        <div className="p-4">
          {wakeUpPlan ? <div className="space-y-3">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="h-2 w-24 sm:w-40 bg-indigo/10 rounded-full overflow-hidden">
                      <div className="h-full bg-coral transition-all duration-700 rounded-full" style={{
              ...
              <div className="h-48">
                ...
                bottom: 5
                  ...
                  fill: '#2D3142'
                    ...
                    <YAxis tickFormatter={formatMinutes} tick={{
                  fontSize: 10,
                  fill: '#2D3142'
                  ...
                  marginTop: '5px'
                    ...
                    <Line type="monotone" dataKey="plannedWakeUp" stroke="#BFD7EA" strokeWidth={2} dot={{
                  r: 3,
                  fill: '#BFD7EA',
                  strokeWidth: 1,
                  stroke: '#FFF'
                }} name="Planned" />
                    <Line type="monotone" dataKey="actualWakeUp" stroke="#FF7A5A" strokeWidth={2} dot={{
                  r: 3,
                  fill: '#FF7A5A',
                  strokeWidth: 1,
                  stroke: '#FFF'
              ...
              {expanded && <div className="pt-2 space-y-3">
                ...
                return <div key={index} className={`p-2 rounded-lg border flex justify-between items-center
                          ...
                          <div className="flex items-center gap-2">
                            {interval.completed && <span className="text-[10px] bg-emerald-100 text-emerald-600 px-1.5 py-0.5 rounded-full font-medium">
                                ✓
                              </span>}
                          </div>
                        </div>;
